...
Elaboración de pagina web que almacena 13 problemas resueltos en java script
## 👤 Datos del Alumno
| Campo | Información |
|-------|-------------|
| Nombre completo | [Jesus Adrian Villalobos Robles] |
...
- Título del ejercicio: [Problemas Desiciones]
- Descripción:  
  [Desarrollar y resolver 13 problemas en java script para desarrollo de logica todos almacenados en una pagina web.]
